/** Oscillope Arduino - test des entrées analogiques - Giloop
 * Potentiomètres et capteurs connectés à une arduino 
 * pour tester les valeurs lues et les min max des capteurs
 * Créé le 02/01/2015
 * La carte arduino utilise un sketch standard firmata
 */
...
void setup() {
  ...
  // Couleurs de chaque courbe de capteur
